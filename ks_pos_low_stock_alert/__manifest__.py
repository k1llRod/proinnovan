# -*- coding: utf-8 -*-
{
    ...
    'assets' : {
        'point_of_sale.assets': [
            ...
            'ks_pos_low_stock_alert/static/src/js/OrderReceipt.js',
        ],
        'web.assets_qweb': [
            'ks_pos_low_stock_alert/static/src/xml/ks_low_stock.xml',
            'ks_pos_low_stock_alert/static/src/xml/pos_receipt.xml',
            'ks_pos_low_stock_alert/static/src/xml/OrderReceipt.xml',
        ],
        'web.assets_backend': [
            'ks_pos_low_stock_alert/static/src/js/pos_receipt.js',
        ],
    }
}
